...
var file_message_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x22, 0x5a, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x6f, 0x62, 0x62,
	0x79, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x68, 0x6f, 0x62, 0x62, 0x79, 0x32, 0x39,
	0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2a, 0x0a,
...
var file_message_proto_depIdxs = []int32{
	0, // 0: ServiceUser.GetUserInfo:input_type -> UserRequest
	1, // 1: ServiceUser.GetUserInfo:output_type -> UserResponse
...
func (c *serviceUserClient) GetUserInfo(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/ServiceUser/GetUserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedServiceUserServer can be embedded to have forward compatible implementations.
type UnimplementedServiceUserServer struct {
}

func (*UnimplementedServiceUserServer) GetUserInfo(context.Context, *UserRequest) (*UserResponse, error) {
...
func _ServiceUser_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceUserServer).GetUserInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ServiceUser/GetUserInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceUserServer).GetUserInfo(ctx, req.(*UserRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ServiceUser_GetUserInfo_Handler,
		},
	},
